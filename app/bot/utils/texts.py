    ...
    def data(self) -> dict:
        ...
        return {
            ...
            "ru": {
                ...
                "main_menu": """✅ Ваша заявка № #1035737 принята

👩‍💻 Менеджер Эллина уже подключается к чату

➡️ Написать в личные сообщения: @unifyhub""",
                "get_to_know_us": """Давайте познакомимся поближе! 
                
Расскажите, как вы узнали о нас.
Выберите подходящий вариант из списка:""",
                "thanks_feedback": "Спасибо за обратную связь! ☺️",
                "greeting_morning": "Доброе утро! 🤗",
                "greeting_day": "Добрый день! 🤗",
                "greeting_evening": "Добрый вечер! 🤗",
                "ready_to_help": "Готовы рассказать подробнее про корпоративное обучение, какой у Вас вопрос?",
